...
void main() {
  group('Rectangle.worldExtents', () {
    test('half-extents point along the local axes, unrotated', () {
      ...
      final MVector2 ex = .zero();
      final MVector2 ey = .zero();

      shape.worldExtents(transform(), ex, ey);
    ...
    test('rotates with the transform', () {
      ...
      shape.worldExtents(transform(angle: math.pi / 2), ex, ey);
    ...
    test('ignores translation - extents are directions, not points', () {
      ...
      shape.worldExtents(transform(position: .all(100)), ex, ey);
    ...
    test('scales with the transform', () {
      ...
      shape.worldExtents(transform(scale: .new(2, 3)), ex, ey);
